...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.addAttributes = function () {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.removeAttributes = function () {
  for (let i = 0; i < this.length; i++) {
    if (arguments.length) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.animateFadeIn = function (i, display, duration, final) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.animateFadeOut = function (i, duration, final) {
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').click(() => Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').createModal({
  text: {
    title: 'Modal title',
    body: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo voluptatibus ex odit minus esse reprehenderit, excepturi, nihil exercitationem non est enim reiciendis voluptatem culpa expedita a suscipit possimus corporis blanditiis.'
  },
  btns: {
    count: 3,
